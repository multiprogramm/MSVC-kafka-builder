...
REM FIX project
%REPLACE_ALL_PATH% "librdkafka.vcxproj" ^
...
msbuild librdkafka.sln /t:librdkafka;librdkafkacpp /p:Configuration=Debug /p:Platform=Win32
...
msbuild librdkafka.sln /t:librdkafka;librdkafkacpp /p:Configuration=Release /p:Platform=Win32
...
msbuild librdkafka.sln /t:librdkafka;librdkafkacpp /p:Configuration=Debug /p:Platform=x64
...
msbuild librdkafka.sln /t:librdkafka;librdkafkacpp /p:Configuration=Release /p:Platform=x64
